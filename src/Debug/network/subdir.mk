...
../network/EpollProxy.cpp \
../network/SSLClientSocket.cpp \
../network/SSLServerSocket.cpp \
../network/ServerSocket.cpp 

OBJS += \
./network/ClientSocket.o \
./network/EpollProxy.o \
./network/SSLClientSocket.o \
./network/SSLServerSocket.o \
./network/ServerSocket.o 

CPP_DEPS += \
./network/ClientSocket.d \
./network/EpollProxy.d \
./network/SSLClientSocket.d \
./network/SSLServerSocket.d \
./network/ServerSocket.d 
