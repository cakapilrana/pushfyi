...
*********************************************************
*/
#ifndef __SECURE_TCP_SERVER__
#define __SECURE_TCP_SERVER__
 ...
 *
 * This class listens for incoming requests from client applications on a secure port.
 ...
 *
 */
class SecureTCPServer : public Runnable, ServerSocket,
...
private:
     ...
     */
    SecureTCPServer(const SecureTCPServer&);

    /*!
     * Self Instance
     */
    static SecureTCPServer* mInstance;
...
public:
     ...
     */
    static SecureTCPServer* getInstance();
